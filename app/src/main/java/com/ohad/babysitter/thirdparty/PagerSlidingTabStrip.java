...
package com.ohad.babysitter.thirdparty;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // if there is an offset, play interpolating left and right coordinates between current and next tab
    ...
    public void setTextColor(int position, int textColor) {
        updateTabStyles();
